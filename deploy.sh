...
oc create sa ipfailover cluster-hosted-keepalived -n keepalived-v6
oc adm policy add-scc-to-user hostnetwork -n keepalived-v6 -z cluster-hosted-keepalived
